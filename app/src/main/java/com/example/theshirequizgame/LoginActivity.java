...
//initializing
    ...
    private void findViews() {
        ...
        register_txt.setText(Html.fromHtml("<html><body><font color=#91A1AB> <small> Don't have an account with us yet?  </small> </font> <font color=#826FDB><big>  Register </big> </font> </body><html>"));
    }
    ...
    //once user clicks register button the app moves to the registration screen
